...
- **Win-back.** A randomised holdout of *matched lapsed users* is mandatory, and the primary metric is **re-dormancy** — share still active at D14 and D30 after return — not the reactivation click, which any large bribe inflates.
