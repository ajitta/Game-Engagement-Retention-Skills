...
5. **Progress and near-completion** — the bar alone misleads, so put numeric remaining steps beside it near the goal and plan for a mid-journey dip rather than a smooth goal gradient. Evidence, populations and the two-sided difficulty window: `${CLAUDE_SKILL_DIR}/../interaction-reward-moments/references/patterns-progress.md`.
