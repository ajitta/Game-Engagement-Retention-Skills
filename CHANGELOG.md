...
Tooling and documents only. No skill, reference module or routing text changed, so
`plugin.json` stays at 2.2.1 — a bump exists to make an installed copy re-fetch, and
there is nothing here for it to re-fetch.
