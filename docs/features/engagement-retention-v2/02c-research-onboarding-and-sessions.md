...
Vendor day-N conventions and session rules: see 02b §1.2 (canonical). One source that table does not carry and this document relies on in §5.2: the GA4 session glossary, 30-min inactivity timeout, max 7h55m (Google, 2025, https://support.google.com/analytics/answer/12798876?hl=en).
...
The two rows onboarding actually needs:

| Population (mobile, 2025 data) | D1 | D7 |
|---|---|---|
| All games ≥1k MAU — P50 | ~22% | just under 4% |
| same — P90 | ~40% | 11–12% |

Full distribution (P75, P99, regional and D30 columns) with population header: 02b §3.1.

GameAnalytics, 2026 Mobile & PC Gaming Benchmarks, **16,262** live mobile games with a 1,000-MAU floor, stated 9-region scope but only 8 regions in the published regional table, calendar-2025 data (https://www.gameanalytics.com/reports/2026-mobile-pc-gaming-benchmarks). **[corrected]** — adversarial verification confirmed the numbers and fixed the P99 D7 band, which is stated as **25–28%** (not ">25%, peaking >28%"); and the report's regional-convergence sentence is **[contested]** between two verifier transcriptions — state the finding in your own words (baselines converge at the median, spread at the top) rather than quoting it (see 02b §3.1). Regional D1 medians: Oceania 25.63%, North America 23.28%, Europe 22.20%, Africa 18.52%, Asia 17.50%.

PC is a different species: median D1 ~7%, D7 **[contested]** ~1.1–1.3% on the HTML page versus ~1.7–1.8% in the PDF text (an unresolved discrepancy; always carry the tag), D30 ~0.2–0.25%, median 32–33 min/day across ~18-min sessions (GameAnalytics 2026, 3,582 PC games, ≥100 MAU, 4+ months live). The report's own framing: "PC engagement is depth-driven, so mobile-style retention reads differently."
...
- **Length can be pure idle time.** Secondary coverage of the KOCCA 2025 survey reports auto-play use in the region of 30% **[unverified — no primary table located; do not quote the figure, use it only as a reason to distrust minutes-as-engagement]** — session minutes there are not engagement minutes.
...
Sources: Baumel et al., *JMIR* 2019 (Google Play panel data; **>80% of the drop occurs between day 1 and day 10**; median daily use ~13 min among active users; day-30 medians by technique: peer support 8.9%, tracker/diary 6.1%, mindfulness 4.7%, https://www.jmir.org/2019/9/e14567); Kidman et al., *JMIR* Dec 2024 scoping review (curvilinear abandonment; physical activity 54–75%, diet 86%, alcohol 95–97%, https://www.jmir.org/2024/1/e56897); Amplitude 2025 Product Benchmark Report (https://amplitude.com/blog/7-percent-retention-rule). Note the Baumel/Kidman in-the-wild rates far exceed controlled-trial attrition of 18.6% post-test and 28.4% at follow-up (Liu, Torous, Linardon et al., *JAMA Psychiatry* 83(1):43–50, 79 RCTs, https://doi.org/10.1001/jamapsychiatry.2025.3439) — trial engagement is not in-the-wild engagement.
