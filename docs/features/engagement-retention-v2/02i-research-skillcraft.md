...
**Evidence-hygiene cases come straight out of this research set's corrections.** Case one: ask a Korean-compliance question and assert that the answer does *not* name a "Prevent Game Addiction and Promotion of Healthy Gaming Act" — no such statute was ever enacted — and *does* anchor on 게임산업진흥에 관한 법률 Art. 33(2), whose per-item probability disclosure duty has been in force since 2024-03-22 (current consolidated text 시행 2025-10-23), with the Art. 33-2 damages regime promulgated 2025-01-31 and in force 2025-08-01, applying only to display-duty violations occurring on or after that date **[corrected]** (see 02f §1.2 and 02h §5.1). Second assertion on the same case: the answer must **not** describe the 3x figure as automatic punitive damages layered on top of compensatory damages — the operator is liable unless it proves absence of *both* intent and negligence, and only where the court finds the violation intentional *may* it award up to three times the damages it estimates. Case two: ask for a retention benchmark and assert the answer carries population and definition, not a bare number.
