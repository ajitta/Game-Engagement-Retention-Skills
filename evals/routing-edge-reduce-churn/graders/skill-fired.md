...
The tempting wrong route: no artifact is named at all, so the advisor's "the moment-to-return link itself" row looks available. Only one deliverable is present — the lifecycle — and a single-layer ask is never the advisor's.
