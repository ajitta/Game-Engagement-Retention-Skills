...
3. **A complete proposal set.** The mode's artifact is filled end to end — tier curve and reward pacing actually answered, with acceptance bounds — plus `## 전제`, `## 순서`, `## 측정 설계`, `## 근거`.
